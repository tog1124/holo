			...
			<div class="row">
				<div class="col-md-9 col-lg-9">
					<div class="section-14-box">
						<div class="date">
							<span>July</span><br>30<br> <span>2016</span>
						</div>
						<img src="images/blog/blog-1.jpg" class="img-responsive"
							alt="Blog image 1">
						<h3>
							<a href="#">INTEGER SAGITTIS VENENATIS SIT</a>
						</h3>
						<div class="row">
							<div class="col-md-12 col-lg-12">
								<div class="text-left comments">
									By<a href="#">rkwebdesigns</a>
								</div>
							</div>
						</div>
		...
		<div class="demo-gallery">
			<ul id="lightgallery" class="list-unstyled row">
				<li class="col-xs-6 col-sm-4 col-md-3"
					data-responsive="resources/SRC2/lightgallery/demo/img/1-375.jpg 375, resources/SRC2/lightgallery/demo/img/1-480.jpg 480, resources/SRC2/lightgallery/demo/img/1.jpg 800"
					data-src="resources/SRC2/lightgallery/demo/img/1-1600.jpg"
					data-sub-html="<h4>Fading Light</h4><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
					<a href=""> <img class="img-responsive"
						src="resources/SRC2/lightgallery/demo/img/thumb-1.jpg">
				</a>
				</li>
				<li class="col-xs-6 col-sm-4 col-md-3"
					data-responsive="resources/SRC2/lightgallery/demo/img/2-375.jpg 375, resources/SRC2/lightgallery/demo/img/2-480.jpg 480, resources/SRC2/lightgallery/demo/img/2.jpg 800"
					data-src="resources/SRC2/lightgallery/demo/img/2-1600.jpg"
					...
					<a href=""> <img class="img-responsive"
						src="resources/SRC2/lightgallery/demo/img/thumb-2.jpg">
				</a>
				</li>
				<li class="col-xs-6 col-sm-4 col-md-3"
					data-responsive="resources/SRC2/lightgallery/demo/img/1-375.jpg 375, resources/SRC2/lightgallery/demo/img/1-480.jpg 480, resources/SRC2/lightgallery/demo/img/1.jpg 800"
			...
			<div class="row">
				<div class="col-md-9 col-lg-9">
					<div class="section-10-box-text-cont">
						...
						<p>Create beautiful, unique websites with impact full landing
							pages and banners, without any coding or design skills.</p>
					</div>
				</div>
				<div class="col-md-col-lg-3">
					<div class="section-10-btn-cont">
						<a href="#" class="btn btn-seconday wow tada">Get Started!</a>
					</div>
				</div>
			</div>
		</div>

...
<section id="inner-title" class="inner-title">
  <div class="container">
    <div class="row">
      <div class="col-lg-8"><h2>404</h2></div>
      <div class="col-lg-4">
...
<section id="section19" class="section19">
  <div class="container">
   <div class="row">
     <div class="col-lg-6"><div class="section19-404"><h1>404</h1><h3>Sorry, it appears the page ypu were looking for dose't exist anymore or might have been moved.</h3></div></div>
     <div class="col-lg-6">
     <div class="section19-subscribe">
     	<h3>To get some updates just subscribe with us.</h3>
     	<div class="control-group form-group">
            <div class="controls">
              <input type="text" class="form-control" id="name" required placeholder="Subscribe your Email ID">

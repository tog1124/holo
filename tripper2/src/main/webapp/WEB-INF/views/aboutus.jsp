...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a href="other.do">See card </a></li>
				...
				<div class="col-md-6 col-lg-6">
					<div class="breadcrumbs">
						<ul>
							...
							<li><a href="other.do">About us</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="section-5-box-text-cont wow fadeInRight">
						<div class="container">
							<div class="row">
								...
								<div class="col-md-4 col-lg-4">
									<div class="section-1-box wow bounceIn" data-wow-delay=".1s">
										...
										<div>
											...
											<h4 class="text-center" name="card-location"
												id="card-location"></h4>
								...
								<h2 style="margin-top: 160px;">맘에드는 사람에게 먼저 다가가세요!</h2>
								<p>당신 스스로가 하지 않으면 아무도 당신의 운명을 개선시켜 주지 않을 것이다 - B.브레히트</p>
							</div>
							<div class="col-md-12 col-lg-12">
								<div class="section-5-box-text-cont wow fadeInRight">
									<h2>밑에 카드에서 맘에드는 사람을 선택하세요</h2>
									<h2>↓↓↓↓</h2>
	...
	<section id="section17" class=" section17">
		<div class="container">
			<div class="row">
				<div class="col-md-12">

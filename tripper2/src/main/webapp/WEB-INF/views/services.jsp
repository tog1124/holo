...
<section id="section4" class="section-margine">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-lg-4"><img src="images/device_02.png" class="img-responsive wow zoomIn" alt=""></div>
      <div class="col-md-4 col-lg-4">
        <div class="section-4-box wow fadeIn">
        ...
        <div class="section-4-box wow fadeIn" data-wow-delay=".2s">
          <div class="section-4-box-icon-cont"><i class="fa fa-font fa-2x"></i></div>
          <div class="section-4-box-text-cont">
            <h5>google fonts</h5>
            <p>Using many font styles can slow down your webpage, so only select thefont styles that you</p>
          </div>
    ...
    <div class="row">
      <div class="col-md-12 col-lg-12">
       ...
       <h2>더 많은 사람들 보러가기</h2>
						...
						<a href="other.do" class="btn btn-primary">Get Started! <i class="fa fa-angle-double-right"></i></a> 
		</div>
      </div>
    </div>
  </div>
...
<section id="section10" class="section-10-background">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-lg-3">
        <div class="section-10-btn-cont"><a href="#" class="btn btn-seconday wow tada">Get Started! <i class="fa fa-angle-double-right"></i></a></div>
      </div>
    </div>
  </div>
</section>

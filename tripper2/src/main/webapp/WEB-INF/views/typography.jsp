...
<section id="section21" class="section21">
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <div class="section-21-box"> 
          <h1>Heading 1</h1>
          <p class="color-ash">Credibly promote cross-platform internal or "organic" sources whereas real-time functionalities. Appropriately communicate leading-edge e-commerce and standardized best practices. Phosfluorescently empower error-free web services for fully researched internal or "organic" sources. Holisticly create viral e-services and client-centered scenarios. Authoritatively transform orthogonal web-readiness before robust methodologies.</p>
        </div>
        <div class="section-21-box"> 
          <h2>Heading 2</h2>
          <p class="color-ash">Credibly promote cross-platform internal or "organic" sources whereas real-time functionalities. Appropriately communicate leading-edge e-commerce and standardized best practices. Phosfluorescently empower error-free web services for fully researched internal or "organic" sources. Holisticly create viral e-services and client-centered scenarios. Authoritatively transform orthogonal web-readiness before robust methodologies.</p>
